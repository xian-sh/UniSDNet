...
def build_proposal_conv(cfg, mask2d,x):
    input_size = x
    hidden_size = cfg.MODEL.DTF.PREDICTOR.HIDDEN_SIZE
    kernel_size = cfg.MODEL.DTF.PREDICTOR.KERNEL_SIZE
    num_stack_layers = cfg.MODEL.DTF.PREDICTOR.NUM_STACK_LAYERS
    output_size = cfg.MODEL.DTF.JOINT_SPACE_SIZE

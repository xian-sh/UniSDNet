...
from dtfnet.data.datasets.utils import box_iou
...
def build_bce_loss(cfg, mask2d):
    min_iou = cfg.MODEL.DTF.LOSS.MIN_IOU 
    max_iou = cfg.MODEL.DTF.LOSS.MAX_IOU
...
class ContrastiveLoss(object):
    def __init__(self, cfg, mask2d):
        self.mask2d = mask2d
        self.T_v = cfg.MODEL.DTF.LOSS.TAU_VIDEO
        self.T_s = cfg.MODEL.DTF.LOSS.TAU_SENT
        self.cri = torch.nn.CrossEntropyLoss()
        self.neg_iou = cfg.MODEL.DTF.LOSS.NEGATIVE_VIDEO_IOU
        self.top_k = cfg.MODEL.DTF.LOSS.NUM_POSTIVE_VIDEO_PROPOSAL
        self.sent_removal_iou = cfg.MODEL.DTF.LOSS.SENT_REMOVAL_IOU
        self.margin = cfg.MODEL.DTF.LOSS.MARGIN
        self.eps = 1e-6

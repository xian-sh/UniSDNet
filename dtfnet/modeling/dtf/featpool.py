...
def build_featpool(cfg):
    input_size = cfg.MODEL.DTF.FEATPOOL.INPUT_SIZE
    hidden_size = cfg.MODEL.DTF.FEATPOOL.HIDDEN_SIZE
    kernel_size = cfg.MODEL.DTF.FEATPOOL.KERNEL_SIZE  # 4 for anet, 2 for tacos, 16 for charades
    stride = cfg.INPUT.NUM_PRE_CLIPS // cfg.MODEL.DTF.NUM_CLIPS

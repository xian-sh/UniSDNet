...
if __name__ == '__main__':
    text_path1 = r'G:\Code\TransRet\dataset\TACoS\test_audio_new.json'
    text_path2 = r'G:\Code\TransRet\dataset\TACoS\train_audio_new.json'
    text_path3 = r'G:\Code\TransRet\dataset\TACoS\val_audio_new.json'

    text_dir1 = r'G:\Dataset\data\TACoS\text_distbert_feat_new'
    ...
    # text_distbert_feat_extract(text_path1,text_dir1)
    # text_distbert_feat_extract(text_path2,text_dir1)
    # text_distbert_feat_extract(text_path3,text_dir1)

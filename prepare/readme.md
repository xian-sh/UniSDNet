...
1. the original split(no audio):   https://cs.stanford.edu/people/ranjaykrishna/densevid/
    
or look at the **'root/data/ActivityNet/'** folder, which includes **'{train/val/test}.json'**


2.caption file include audio(**record per caption individually**): 

look at the **'root/data/ActivityNet/'** folder, which includes **'new_{train/val/test}_data.json'**


3.caption file include audio(**all record of video related captions**):

...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='G:\\ActivityNetDataset\\split128\\v1-2\\test',
                        help='Number of frames to extract from a video')
    args = parser.parse_args()

    print(f'Dumping {args.num_frames} frames from {args.dataset} dataset...')
    # start_time = time.time()
    # G:\\ActivityNetDataset\\split128\\v1-2\\test
    extract_N_frames_from_all_videos(
        data_dir='G:\\ActivityNetDataset\\split128\\v1-2\\test',
        save_dir=os.path.join(args.root_dir, 'vedio', args.dataset, 'frames'),
        resize=args.resize,
        scale=args.scale,
        num_frames=args.num_frames
    )
    extract_N_frames_from_all_videos(
        data_dir='G:\\ActivityNetDataset\\split128\\v1-2\\train',
        save_dir=os.path.join(args.root_dir, 'vedio', args.dataset, 'frames'),
        resize=args.resize,
        scale=args.scale,
        num_frames=args.num_frames
    ...
    extract_N_frames_from_all_videos(
        data_dir='G:\\ActivityNetDataset\\split128\\v1-2\\val',
        save_dir=os.path.join(args.root_dir, 'vedio', args.dataset, 'frames'),
        resize=args.resize,
        scale=args.scale,
        num_frames=args.num_frames
    ...
    extract_N_frames_from_all_videos(
        data_dir='G:\\ActivityNetDataset\\split128\\v1-3\\test',
        save_dir=os.path.join(args.root_dir, 'vedio', args.dataset, 'frames'),
        resize=args.resize,
        scale=args.scale,
        num_frames=args.num_frames
    ...
    extract_N_frames_from_all_videos(
        data_dir='G:\\ActivityNetDataset\\split128\\v1-3\\train_val',
        save_dir=os.path.join(args.root_dir, 'vedio', args.dataset, 'frames'),
        resize=args.resize,
        scale=args.scale,
        num_frames=args.num_frames

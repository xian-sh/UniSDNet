...
from dtfnet.engine.trainer import do_train
...
from dtfnet.utils.miscellaneous import mkdir, save_config
import logging
...
def train(cfg, local_rank, distributed):
    ...
    if cfg.SOLVER.RESUME:
        ...
        path = '%s_model_%de.pth' % (cfg.MODEL.DTF.FEAT2D.NAME, cfg.SOLVER.RESUME_EPOCH - 1)
        weight_path = os.path.join(cfg.OUTPUT_DIR, path)
...
def main():
    ...
    logger = setup_logger("dtf", output_dir, get_rank())
